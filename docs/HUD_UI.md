...
* **SettingsScreen:** Features 3 categorized sections (`AUDIO`, `GAMEPLAY & CONTROLS`, `DISPLAY & SYSTEM`) using tactile retro plate badges (`4px` radii, gold border) and trailing hairline rules, balanced section spacing (36px inter-section clearance, 26px title/footer gap), and off-white row label contrast typography (`Color(0.92, 0.92, 0.92, 0.95)`).
