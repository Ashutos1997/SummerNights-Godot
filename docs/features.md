...
*   **Menu Overlays:** All menus (Pause, Settings, Credits, Achievements, Buffs) are unified by a sleek golden border, an ultra-dark background dimming effect, consistent left-aligned typography with 96px interior margins, uniform title dividers, and dynamic gold-tinted title icons.
