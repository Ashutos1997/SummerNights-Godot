...
*   **Endless/Survival Mode:**
  ...
  *   **Rogue-lite Wave Perks (Drafting):** After surviving every 5th wave (Boss Wave), the game pauses and the player is presented with a choice of 3 randomized perks (e.g., +15% Max Capacity, +15% Critical Damage). The pool also includes "trade-off" perks (e.g., Glass Cannon: +40% Crit Damage but -15% Tank Size) to encourage deeper strategic builds. These perks permanently stack for the remainder of the Endless run, creating massive strategic build diversity.
