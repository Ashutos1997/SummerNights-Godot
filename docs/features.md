...
*   **Dynamic UI Elements:**
    ...
    *   Standardized Resource Meters (Water Tank, Ice Burst pips, and Catastrom Ultimate) engineered with uniform label margins and left-aligned charge pips to maintain flush right-alignment with the screen edge.
