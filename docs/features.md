...
* **Menus:** Unified golden borders, 96px margins, centered/left-aligned layouts, full Gamepad navigation, and categorized Settings sections with tactile retro plate badges and off-white row typography.
