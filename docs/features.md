...
* **Celestial Awakening (Nine Tails):** 15-second super state generating 9 procedural cyan/white hydro-ribbon tails cascading from an overhead celestial canopy. Features staggered henshin bloom (center crown erupts first, rippling outward with elastic spring), multi-octave traveling hydro-waves, 3D ribbon twist, responsive player aim inertia/sway, and subtle solar wisp tips without obstructing the beach or reticle.
