...
열대 해변에서 물 대포를 들고 서 있습니다. 태양은 지평선에 자리 잡고 끊임없이 열기를 내뿜습니다. 물을 뿜어 태양을 식히며 5단계의 난이도를 클리어하세요.

- 태양이 식을수록 하늘이 붉은색에서 주황색, 파란색으로 변합니다.
- 태양 표면에 태양 열 분출구가 나타나 치명적인 냉각 보너스를 제공합니다.
- 태양이 포물선 궤도로 불꽃 파편을 발사합니다. 물로 공중에서 요격하면 물통 +30%를 획득합니다.
